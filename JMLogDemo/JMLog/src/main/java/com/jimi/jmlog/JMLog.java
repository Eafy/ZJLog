...
import com.jimi.jmlog.JMLogJni;
...
public class JMLog {
    static {
        try {
            System.loadLibrary("JMLog");
        } catch (UnsatisfiedLinkError ule) {
            Log.e("JMLog", "loadLibrary JMLog failed!");
        }
    }

    private static String mTAG = "JMLog";
    ...
    private static Logger getLoger(String tag) {
        if (bIsFirstRun) {
            ...
            String fileName = getLogFilePath() + "JMLog.log";
            if (mFileName != null) {
    ...
    private static final String getLogFilePath() {
        ...
        return Environment.getExternalStorageDirectory().getAbsolutePath() + "/JMLog" + File.separator;
    }
